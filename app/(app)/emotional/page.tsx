      ...
      <div className="mt-5 grid gap-5 xl:grid-cols-2">
          ...
          <div className="space-y-2 p-4 sm:p-5">
            {triggers.length ? (
              triggers.map((trigger) => (
                <div key={trigger.id} className="flex items-center justify-between gap-3 rounded-[12px] bg-card px-3 py-2">
        ...
        <Card className="overflow-hidden">
          ...
          <div className="space-y-2 p-4 sm:p-5">
            {usages.length ? (
              usages.map((usage) => (
                <div key={usage.id} className="rounded-[12px] bg-card px-3 py-2">
