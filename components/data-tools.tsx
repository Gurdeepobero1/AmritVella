...
export function DataTools() {
  ...
  return (
    <div className="grid gap-5 lg:grid-cols-3">
      <section className="rounded-[12px] border border-hairline bg-paper p-5 text-navy-950">
        ...
        <a
          className="focus-ring mt-4 inline-flex rounded-[8px] bg-saffron-500 px-5 py-3 text-sm font-bold leading-none text-white"
          href="/api/export"
        >
          Export JSON
        </a>
      ...
      <section className="rounded-[12px] border border-hairline bg-paper p-5 text-navy-950 lg:col-span-3">
        ...
        <button
          type="button"
          className="focus-ring mt-4 rounded-[12px] bg-card px-5 py-3 text-sm font-bold leading-none text-navy-950"
          onClick={async () => {
            localStorage.clear();
      ...
      {status ? <div className="rounded-[12px] border border-hairline bg-paper p-3 text-sm text-steel-500 lg:col-span-3">{status}</div> : null}
    </div>
  );
}
